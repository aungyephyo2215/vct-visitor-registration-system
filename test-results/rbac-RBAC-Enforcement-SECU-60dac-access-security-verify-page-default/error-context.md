...
- Name: rbac.spec.ts >> RBAC Enforcement >> SECURITY_GUARD can access security verify page
- Location: tests/e2e/rbac.spec.ts:19:7
...
Locator: locator('h1')
Expected substring: "Security Verification"
Timeout: 5000ms
